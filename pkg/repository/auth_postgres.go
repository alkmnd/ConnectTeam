...
func (r *AuthPostgres) CreateUser(user connectteam.User) (int, error) {
	var id int
	query := fmt.Sprintf("INSERT INTO %s (email, first_name, second_name, password_hash, is_verified, access, company_name, profile_image) values ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id", usersTable)
